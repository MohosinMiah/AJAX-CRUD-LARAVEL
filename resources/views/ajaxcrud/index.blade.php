          ...
          <table class="table table-bordered" id="laravel_crud">
           ...
           <tbody id="posts-crud">
              ...
              <tr id="post_id_{{ $post->id }}">
                 ...
                 <td>
                  <a href="javascript:void(0)" onclick="return confirm('Are You sure want to delete ! ');" id="delete-post" data-id="{{ $post->id }}" class="btn btn-danger delete-post">Delete</a></td>
              </tr>
              @endforeach
           </tbody>
          </table>
